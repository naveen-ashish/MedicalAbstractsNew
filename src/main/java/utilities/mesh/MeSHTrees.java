...
public class MeSHTrees {
	...
	private List<String> stkMesh = new ArrayList<String>();
	 ...
	 */
	public void createGroups(List<String> stk) {
	...
	public void createMeshMap() {
		...
		// Stack
		// stk=utilities.IO.readFileStk("resources/MeSH_terms/Mesh-Animal.txt-treenumber.txt");

		List<String> stk = RR.meshAnimalNumber;
	...
	private void processColl(String coll) {
		...
		// Stack
		// stk=utilities.IO.readFileStk("resources/MeSH_terms/"+coll+".txt-treenumber.txt");

		List<String> stk = new ArrayList<String>();

		if (coll.contains("Animal"))
			stk = RR.meshAnimalNumber;

		if (coll.contains("Human"))
			stk = RR.meshHumanNumber;

		if (coll.contains("itro"))
			stk = RR.meshInvitroNumber;

		if (coll.contains("ammal"))
			stk = RR.meshMammalNumber;

		if (coll.contains("Cell"))
			stk = RR.meshCellNumber;

		if (coll.contains("AllMesh"))
			stk = RR.meshAllMeshNumber;
	...
	private void process(List<String> stk) {
